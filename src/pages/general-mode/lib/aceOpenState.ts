 ...
 *
 * ⚠️ 원본은 이 10칸이 **전역 기록**이고 G포인트도 같은 기록의 `+0x64` 다 (0xa3f6 이 `r5+0x30+칸`,
 *    0xa3f4 가 `r5+0x64` — **같은 객체**). 웹판은 G 를 `entities/wallet` 지갑에 따로 담으므로
 *    저장 칸은 둘이지만 **둘 다 모드와 상관없는 전역**이라 뜻은 원본과 같다.
 */
