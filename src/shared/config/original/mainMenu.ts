...
export const TOP_MENU: readonly MainMenuEntry[] = [
  ...
  { id: '스페셜', labelFrame: 1, isAvailable: false, description: 'G포인트 구매 및 각종 유용한!N기능을 사용할 수 있습니다' }, // [1]
  { id: '도움말', labelFrame: 2, isAvailable: false, description: '게임에 대한 각종 도움말을!N살펴볼 수 있습니다' }, // [2]
  { id: '환경설정', labelFrame: 3, isAvailable: false, description: '게임 환경 및 조작 범위!N데이터를 관리할 수 있습니다' }, // [3]
...
export const GAME_START_MENU: readonly MainMenuEntry[] = [
  ...
  { id: '일반모드', labelFrame: 7, isAvailable: false, description: '원하는 팀을 선택해 자유롭게!N플레이하는 모드입니다' }, // [7]
