...
OUTFIT_RULES: dict[str, str] = {
    ...
    #   0x79832 · 0x7984a 투수 손 · 0x79870 · 0x79888 투수 다리: 같은 식
    ...
    'item/item_pit_hand_0': '등급 n: 0 → 기본색 · 1~6 → 줄 n−1 (0x79832)',
    'item/item_pit_hand_7': '등급 n: 7 → 기본색 · 8~10 → 줄 n−8 (0x7984a)',
    'item/item_pit_leg_0': '등급 n: 0 → 기본색 · 1~6 → 줄 n−1 (0x79870)',
    'item/item_pit_leg_7': '등급 n: 7 → 기본색 · 8~10 → 줄 n−8 (0x79888)',
}
